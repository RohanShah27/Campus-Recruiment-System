...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["Gathering Student data", "Loading TPO policies", "Invading Industries", "Collecting Information", "Connecting to Database", "Validating Connections", "Shuffling data", "Loading images", "Generating Motivation", "Simulating workflow", "Recruiting", "Lining up Toppers", "Importing Rules", "Waking up Dexter", "Finding the perfect Job"]);
